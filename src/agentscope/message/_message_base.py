...
class Msg:
    ...
    def __init__(
        ...
        Args:
            ...
            speech (`AudioBlock | list[AudioBlock] | None`, optional):
                The speech content to be played along with the message in the
                frontend. Usually generated by TTS models or multimodal models.
        """
        ...
        assert isinstance(speech, (dict, list, type(None))), (
            "The speech must be an AudioBlock, a list of AudioBlocks, "
            "or None.",
        )
        self.speech = speech
    ...
    def from_dict(cls, json_data: dict) -> "Msg":
        ...
        new_obj = cls(
            ...
            speech=json_data.get("speech", None),
        )
